...
const types = require("../typology.js");
const Typology = types;
...
describe("Typology", function() {
  it("types.get", function() {
    ...
    assert.deepEqual(types.get(() => {}), "function");
  ...
  const doMatch = [
    ...
    dontMatch = [
      /*  0 */ [
        42,
        "boolean",
        /Expected a "boolean" but found a "number"/,
        undefined
      ],
      ...
      [
        () => {},
        "string",
        /Expected a "string" but found a "function"/,
        undefined
      ],
      [
        [1, 2, 3],
        "function",
        /Expected a "function" but found a "array"/,
        undefined
      ],
      ...
      /*  5 */ [
        /rhqq2/,
        "date",
        /Expected a "date" but found a "regexp"/,
        undefined
      ],
      [
        { a: 1, b: 2 },
        "regexp",
        /Expected a "regexp" but found a "object"/,
        undefined
      ],
      ...
      /* 10 */ [
        null,
        "string|array",
        /Expected a "string|array" but found a "null"/,
        undefined
      ],
      ...
      [
        { a: "abc", b: 42 },
        { a: "string", b: "object" },
        /Expected a "object" but found a "number"/,
        ["b"]
      ],
      /* 15 */ [
        { b: { a: 1, b: 2 } },
        { a: "string", b: "object" },
        /Expected a "string" but found a "undefined"/,
        ["a"]
      ],
      [
        { a: "abc" },
        { a: "string", b: "object" },
        /Expected a "object" but found a "undefined"/,
        ["b"]
      ],
      [
        { a: "abc", b: { a: 1, b: 2 } },
        { a: "string", b: { a: "string" } },
        /Expected a "string" but found a "number"/,
        ["b", "a"]
      ],
      [
        { a: "abc", b: "def" },
        { a: "string", b: { a: "string" } },
        /Expected an object but found a "string"/,
        ["b"]
      ],
      [
        42,
        { a: "?string|array", b: "?*" },
        /Expected an object but found a "number"/,
        undefined
      ],
      /* 20 */ [
        "hello",
        "!object|string",
        /Expected a "!object|string" but found a "string"/,
        undefined
      ],
      [
        new Date(),
        "primitive",
        /Expected a "primitive" but found a "date"/,
        undefined
      ],
      [
        {},
        "primitive",
        /Expected a "primitive" but found a "object"/,
        undefined
      ],
      [
        [],
        "primitive",
        /Expected a "primitive" but found a "array"/,
        undefined
      ],
      [
        Object.create(null),
  ...
  it("types.scan", function() {
    ...
    assert.deepEqual(types.scan("string", "abc"), {
      expected: "string",
      type: "string",
      value: "abc"
    });
    ...
    assert.deepEqual(types.scan("number", "abc"), {
    ...
    assert.deepEqual(types.scan({ a: "number" }, { a: "abc" }), {
      error: 'Expected a "number" but found a "string".',
      expected: "number",
      type: "string",
      value: "abc",
    ...
    assert.deepEqual(types.scan({ a: ["number"] }, { a: [123, "abc"] }), {
      error: 'Expected a "number" but found a "string".',
      expected: "number",
      type: "string",
      value: "abc",
    ...
    assert.deepEqual(types.scan({ a: "number" }, {}), {
    ...
    assert.deepEqual(types.scan({ a: "number" }, { a: 123, b: 456 }), {
  ...
  it("types.add", function() {
    ...
    assert.throws(function() {
      types.add("number", v => v === +v);
    }, Error);

    // Create a basic type and use it:
    types.add("integer", v => v === +v && v % 1 === 0);
  ...
  it("types.Typology", function() {
    const customTypology = new Typology();
    ...
    const loadedTypology = new Typology({
      napoleon: v => v === "Napoleon" || v === "Bonaparte"
    });
