...
import types, { TypologyType } from '../typology';
...
describe('Typology', function() {
  ...
  // [ value, type ]
  const doMatch: [unknown, TypologyType][] = [
    /*  0 */ [true, 'boolean'],
    [42, 'number'],
    ['abc', 'string'],
    [() => {}, 'function'],
  ...
  const dontMatch: (
    | [unknown, TypologyType]
    | [unknown, TypologyType, RegExp]
    | [unknown, TypologyType, RegExp, (string | number)[] | undefined])[] = [
    /*  0 */ [42, 'boolean', /Expected a "boolean" but found a "number"/, undefined],
    ['abc', 'number', /Expected a "number" but found a "string"/, undefined],
    [() => {}, 'string', /Expected a "string" but found a "function"/, undefined],
  ...
  const typeError = [['abc', 'string|?array'], [{ a: 'abc', b: '12' }, { a: 'sstring' }]];
  ...
  it('types.Typology', function() {
    ...
    const loadedTypology = new Typology<TypologyType>({
